...
public:
	...
	enum class Commands { Continue, TurnRight, TurnLeft };
	...
	void Switches2();
	void Switches3();
	int Switches4(Month month);
	void Switches5(Sign sign, float a, float b);
	float Switches6(float size, Length lenght);
	float Switches7(float mass_of_object, Mass mass);
	void Switches8(int day, Month month);
	void Switches9(int day, Month month);
	void Switches10(Sides side, Commands command);
